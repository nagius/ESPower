var thumbnailviewer={enableTitle:true,enableAnimation:true,definefooter:'<div class="footerbar">CLOSE X</div>',defineLoading:'<img src="https://www.best-microcontroller-projects.com/image-files/loading.gif" /> Loading Image...',scrollbarwidth:16,opacitystring:'filter:progid:DXImageTransform.Microsoft.alpha(opacity=10); -moz-opacity: 0.1; opacity: 0.1',targetlinks:[],createthumbBox:function(){__ez.scxr.getDW(document).write('<div id="thumbBox" onClick="thumbnailviewer.closeit()"><div id="thumbImage"></div>'+this.definefooter+'</div>')
__ez.scxr.getDW(document).write('<div id="thumbLoading">'+this.defineLoading+'</div>')
